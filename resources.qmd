...
listing:
  - id: publications
    contents: "resources/pubs/*.qmd"
    sort: "date desc"
    template: html/listing.ejs
    categories: true
  - id: datasets
    contents: "resources/datasets/*.qmd"
    sort: "date desc"
    template: html/listing.ejs
page-layout: full
...
INvenTree makes several resources available to the public, including datasets, code, visualisations, and publications.
